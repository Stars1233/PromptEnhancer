...
class PromptEnhancerV2:
    def __init__(self, models_root_path, device_map="atuo", torch_dtype="bfloat16"):
...
DEFAULT_MODEL_PATH = os.environ.get("MODEL_OUTPUT_PATH", "/apdcephfs_jn3/share_302243908/aladdinwang/model_weight/cot_taurus_v6_50/global_step0")
